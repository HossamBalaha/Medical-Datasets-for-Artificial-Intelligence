...
- **Related Datasets**:
    - [MSI-MSS Strong Patches](https://data.mendeley.com/datasets/zwr4ntf94j/4) (curated subset)
    - [NCT-CRC-HE-100K](https://data.mendeley.com/datasets/yfp5sfj47m/2) (tissue-type classification)
